     ...
     <div className='max-w-screen-2xl mx-auto container px-6 py-3 md:px-40 '>
      <div className='flex h-screen items-center justify-center'>
        <div className='border-2 border-dashed px-4 py-2 md:px-8 md:py-6 border-indigo-400 rounded-lg shadow-lg'>
          ...
          <p className='text-center text-sm mb-5'>Easily convert word documents to PDF format online, without having to install any software</p>
        <div className='flex flex-col items-center space-y-4'>
          ...
          <span className='text-3xl mr-2 font-bold'>{selectedFile?selectedFile.name: "Choose File"}</span>
           </label>
           <button onClick={handleSubmit} disabled={!selectedFile} className='bg-blue-600 hover:bg-blue-800 duration-300  text-white disabled:bg-gray-400 rounded-lg font-bold px-4 py-2'>Convert File</button>
